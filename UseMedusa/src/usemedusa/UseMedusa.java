 ...
 * @author acer
 */
public class UseMedusa extends Application {
    ...
    public void init() {
        /**
         * Definition of Sections that can be used for - Sections - Areas -
         * TickMarkSections - TickLabelSections
         *
         * Sections will be checked against current value if
         * gauge.getCheckSectionsForValue == true
         */
        ...
        /**
         * Definition of Markers You can attach a listener for the following
         * event types - MARKER_PRESSED - MARKER_RELEASED - MARKER_EXCEEDED -
         * MARKER_UNDERRUN via the MarkerBuilder To receive MARKER_EXCEEDED and
         * MARKER_UNDERRUN events you have to check the current value against
         * each marker by calling the markers checkForValue() method
         */
        ...
        /**
         * Create the Medusa Gauge with most of it's options Simply play with
         * the boolean variables first to see what mean.
         */
        gauge
                = GaugeBuilder.create()
